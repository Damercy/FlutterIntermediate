...
import 'widgets/widget_getter_functions/image_list.dart';
...
class _AppState extends State<App> {
  ...
  void fetchImage() async {
    ...
    print("imageCount: $imageIdCounter");
    ...
    setState(() {
      imageList.add(imageModel);  // Whenever this variable changes, re-render
    });
  }
